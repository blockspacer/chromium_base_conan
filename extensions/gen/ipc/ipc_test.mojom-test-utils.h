// ipc/ipc_test.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef IPC_IPC_TEST_MOJOM_TEST_UTILS_H_
#define IPC_IPC_TEST_MOJOM_TEST_UTILS_H_
...
class  ReflectorInterceptorForTesting : public Reflector {
  ...
  void SyncPing(const std::string& value, SyncPingCallback callback) override;
  void Quit() override;
};
...
class  InterfacePassingTestDriverInterceptorForTesting : public InterfacePassingTestDriver {
  ...
  void GetPingReceiver(std::vector<::mojo::PendingReceiver<PingReceiver>> receiver, GetPingReceiverCallback callback) override;
  void GetAssociatedPingReceiver(std::vector<::mojo::PendingAssociatedReceiver<PingReceiver>> receiver, GetAssociatedPingReceiverCallback callback) override;
  void Quit() override;
};
...
#endif  // IPC_IPC_TEST_MOJOM_TEST_UTILS_H_