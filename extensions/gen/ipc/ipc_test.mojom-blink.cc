// ipc/ipc_test.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "ipc/ipc_test.mojom-blink-import-headers.h"
...
bool SimpleTestDriverRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::SimpleTestDriver::Name_;
...
bool SimpleTestClientRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::SimpleTestClient::Name_;
...
bool PingReceiverRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::PingReceiver::Name_;
...
bool TestStructPasserRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::TestStructPasser::Name_;
...
bool IndirectTestDriverRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::IndirectTestDriver::Name_;
...
bool Reflector::SyncPing(const WTF::String& value, WTF::String* out_response) {
  NOTREACHED();
  return false;
}
...
class Reflector_SyncPing_HandleSyncResponse
 ...
 public:
  Reflector_SyncPing_HandleSyncResponse(
      bool* result, WTF::String* out_response)
 ...
 private:
  bool* result_;
  WTF::String* out_response_;DISALLOW_COPY_AND_ASSIGN(Reflector_SyncPing_HandleSyncResponse);
};
...
void ReflectorProxy::Ping(
    const WTF::String& in_value, PingCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool ReflectorProxy::SyncPing(
    const WTF::String& param_value, WTF::String* out_param_response) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void ReflectorProxy::SyncPing(
    const WTF::String& in_value, SyncPingCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "IPC::mojom::Reflector::SyncPing", "input_parameters",
    [&](perfetto::TracedValue context){
...
class Reflector_SyncPing_Response_Message
 ...
 public:
  ...
  explicit Reflector_SyncPing_Response_Message(
      uint32_t message_flags
      , const WTF::String& param_response
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
          internal::kReflector_SyncPing_Name,
...
bool ReflectorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::Reflector::Name_;
...
bool AssociatedInterfaceVendorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::AssociatedInterfaceVendor::Name_;
...
class InterfacePassingTestDriverProxy_GetPingReceiver_Message
 ...
 public:
  ...
  explicit InterfacePassingTestDriverProxy_GetPingReceiver_Message(
      uint32_t message_flags
      , WTF::Vector<::mojo::PendingReceiver<PingReceiver>> param_receiver
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
 ...
 private:
  ...
  WTF::Vector<::mojo::PendingReceiver<PingReceiver>> param_receiver_;
...
void InterfacePassingTestDriverProxy::GetPingReceiver(
    WTF::Vector<::mojo::PendingReceiver<PingReceiver>> in_receiver, GetPingReceiverCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("receiver"), in_receiver, 
                        "<value of type WTF::Vector<::mojo::PendingReceiver<PingReceiver>>>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
void InterfacePassingTestDriverProxy::GetAssociatedPingReceiver(
    WTF::Vector<::mojo::PendingAssociatedReceiver<PingReceiver>> in_receiver, GetAssociatedPingReceiverCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("receiver"), in_receiver, 
                        "<value of type WTF::Vector<::mojo::PendingAssociatedReceiver<PingReceiver>>>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool InterfacePassingTestDriverStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kInterfacePassingTestDriver_GetPingReceiver_Name: {
      ...
      bool success = true;
      WTF::Vector<::mojo::PendingReceiver<PingReceiver>> p_receiver{};
...
std::move(p_receiver), std::move(callback));
    ...
    case internal::kInterfacePassingTestDriver_GetAssociatedPingReceiver_Name: {
      ...
      bool success = true;
      WTF::Vector<::mojo::PendingAssociatedReceiver<PingReceiver>> p_receiver{};
...
bool InterfacePassingTestDriverRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::IPC::mojom::blink::InterfacePassingTestDriver::Name_;
...
// static
bool StructTraits<::IPC::mojom::blink::TestStruct::DataView, ::IPC::mojom::blink::TestStructPtr>::Read(
    ::IPC::mojom::blink::TestStruct::DataView input,
    ::IPC::mojom::blink::TestStructPtr* output) {
  bool success = true;
  ::IPC::mojom::blink::TestStructPtr result(::IPC::mojom::blink::TestStruct::New());
