// mojo/public/tools/bindings/generators/js_templates/lite/test/test.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/tools/bindings/generators/js_templates/lite/test/test.test-mojom-import-headers.h"
...
TestStruct::TestStruct(
    ...
    const base::Optional<std::string>& title_in,
    std::vector<TestEnum> enums_in,
    const base::flat_map<uint32_t, std::string>& numberToStringMap_in,
    base::flat_map<MessagePtr, std::vector<MessagePtr>> messageToArrayMap_in,
    const base::flat_map<TestEnum, base::flat_map<TestEnum, TestEnum>>& enumToMapMap_in,
    base::flat_map<uint32_t, TestPagePtrInfo> numberToInterfaceProxyMap_in)
    : id(std::move(id_in)),
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<MessagePtr, std::vector<MessagePtr>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const base::flat_map<TestEnum, base::flat_map<TestEnum, TestEnum>>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<uint32_t, TestPagePtrInfo>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void TestPageHandlerProxy::Method1(
    const std::string& in_p1, int32_t in_p2, Method1Callback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class TestPageHandler_Method1_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const std::vector<std::string>& in_values, TestStructPtr in_ts);
...
bool TestPageHandlerRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::test::mojom::TestPageHandler::Name_;
...
bool TestPageRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::test::mojom::TestPage::Name_;
...
// static
bool StructTraits<::test::mojom::Message::DataView, ::test::mojom::MessagePtr>::Read(
    ::test::mojom::Message::DataView input,
    ::test::mojom::MessagePtr* output) {
  bool success = true;
  ::test::mojom::MessagePtr result(::test::mojom::Message::New());
...
// static
bool StructTraits<::test::mojom::TestStruct::DataView, ::test::mojom::TestStructPtr>::Read(
    ::test::mojom::TestStruct::DataView input,
    ::test::mojom::TestStructPtr* output) {
  bool success = true;
  ::test::mojom::TestStructPtr result(::test::mojom::TestStruct::New());
