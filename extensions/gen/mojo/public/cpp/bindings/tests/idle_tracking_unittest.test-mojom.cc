// mojo/public/cpp/bindings/tests/idle_tracking_unittest.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/idle_tracking_unittest.test-mojom-import-headers.h"


#ifndef MOJO_PUBLIC_CPP_BINDINGS_TESTS_IDLE_TRACKING_UNITTEST_TEST_MOJOM_JUMBO_H_
#define MOJO_PUBLIC_CPP_BINDINGS_TESTS_IDLE_TRACKING_UNITTEST_TEST_MOJOM_JUMBO_H_
#endif
namespace mojo {
namespace test {
...
bool TestServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::idle_tracking_unittest::mojom::TestService::Name_;
...
bool KeepAliveRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::idle_tracking_unittest::mojom::KeepAlive::Name_;
