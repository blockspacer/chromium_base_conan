// mojo/public/cpp/bindings/tests/flush_async_unittest.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/flush_async_unittest.test-mojom-import-headers.h"


#ifndef MOJO_PUBLIC_CPP_BINDINGS_TESTS_FLUSH_ASYNC_UNITTEST_TEST_MOJOM_JUMBO_H_
#define MOJO_PUBLIC_CPP_BINDINGS_TESTS_FLUSH_ASYNC_UNITTEST_TEST_MOJOM_JUMBO_H_
#endif
namespace mojo {
namespace test {
...
void WriterProxy::Put(
    const std::string& in_key, const std::string& in_value) {
...
bool WriterRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::flush_async_unittest::mojom::Writer::Name_;
...
bool KeyValueStoreClientRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::flush_async_unittest::mojom::KeyValueStoreClient::Name_;
...
class KeyValueStore_GetSnapshot_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const base::flat_map<std::string, std::string>& in_entries);
...
class KeyValueStore_GetSnapshot_Response_Message
 ...
 public:
  ...
  explicit KeyValueStore_GetSnapshot_Response_Message(
      uint32_t message_flags
      , const base::flat_map<std::string, std::string>& param_entries
  )
      : mojo::internal::UnserializedMessageContext(
          &kMessageTag,
          internal::kKeyValueStore_GetSnapshot_Name,
 ...
 private:
  ...
  base::flat_map<std::string, std::string> param_entries_;
...
bool KeyValueStore_GetSnapshot_ForwardToCallback::Accept(
  ...
  bool success = true;
  base::flat_map<std::string, std::string> p_entries{};
...
bool KeyValueStoreRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::flush_async_unittest::mojom::KeyValueStore::Name_;
...
bool PingerRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::flush_async_unittest::mojom::Pinger::Name_;
