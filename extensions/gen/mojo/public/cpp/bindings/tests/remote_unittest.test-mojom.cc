// mojo/public/cpp/bindings/tests/remote_unittest.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/remote_unittest.test-mojom-import-headers.h"


#ifndef MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_JUMBO_H_
#define MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_JUMBO_H_
#endif
namespace mojo {
namespace test {
...
bool SharedRemoteSyncTestRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::remote_unittest::mojom::SharedRemoteSyncTest::Name_;
...
bool LargeMessageTest::ProcessData(const std::vector<uint8_t>& data, uint64_t* out_data_size) {
  NOTREACHED();
  return false;
}
bool LargeMessageTest::ProcessLotsOfData(const std::vector<uint8_t>& data, uint64_t* out_data_size) {
  NOTREACHED();
  return false;
}
bool LargeMessageTest::GetLotsOfData(uint64_t data_size, std::vector<uint8_t>* out_data) {
  NOTREACHED();
  return false;
}
...
class LargeMessageTest_GetLotsOfData_HandleSyncResponse
 ...
 public:
  LargeMessageTest_GetLotsOfData_HandleSyncResponse(
      bool* result, std::vector<uint8_t>* out_data)
 ...
 private:
  bool* result_;
  std::vector<uint8_t>* out_data_;DISALLOW_COPY_AND_ASSIGN(LargeMessageTest_GetLotsOfData_HandleSyncResponse);
};
...
bool LargeMessageTestProxy::ProcessData(
    const std::vector<uint8_t>& param_data, uint64_t* out_param_data_size) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void LargeMessageTestProxy::ProcessData(
    const std::vector<uint8_t>& in_data, ProcessDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "mojo::test::remote_unittest::mojom::LargeMessageTest::ProcessData", "input_parameters",
    [&](perfetto::TracedValue context){
...
void LargeMessageTestProxy::ProcessLotsOfData(
    const std::vector<uint8_t>& in_data, ProcessLotsOfDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "mojo::test::remote_unittest::mojom::LargeMessageTest::ProcessLotsOfData", "input_parameters",
    [&](perfetto::TracedValue context){
...
bool LargeMessageTestProxy::GetLotsOfData(
    uint64_t param_data_size, std::vector<uint8_t>* out_param_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
bool LargeMessageTestRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::remote_unittest::mojom::LargeMessageTest::Name_;
