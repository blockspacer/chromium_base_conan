// mojo/public/cpp/bindings/tests/connection_group_unittest.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/connection_group_unittest.test-mojom-import-headers.h"
...
bool TestInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::connection_group_unittest::mojom::TestInterface::Name_;
