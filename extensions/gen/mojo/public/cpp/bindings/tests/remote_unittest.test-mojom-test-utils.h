// mojo/public/cpp/bindings/tests/remote_unittest.test-mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_TEST_UTILS_H_
#define MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_TEST_UTILS_H_
...
class  LargeMessageTestInterceptorForTesting : public LargeMessageTest {
  ...
  void ProcessData(const std::vector<uint8_t>& data, ProcessDataCallback callback) override;
  void ProcessLotsOfData(const std::vector<uint8_t>& data, ProcessLotsOfDataCallback callback) override;
...
#endif  // MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_TEST_UTILS_H_