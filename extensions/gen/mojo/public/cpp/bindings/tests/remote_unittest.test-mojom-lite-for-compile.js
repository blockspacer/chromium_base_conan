// mojo/public/cpp/bindings/tests/remote_unittest.test-mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTestReceiver');
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTestCallbackRouter');
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTestInterface');
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTestRemote');
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTestPendingReceiver');
...
/** @interface */
mojo.test.remoteUnittest.mojom.SharedRemoteSyncTestInterface = class {
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTestReceiver');
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTestCallbackRouter');
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTestInterface');
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTestRemote');
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTestPendingReceiver');
...
/** @interface */
mojo.test.remoteUnittest.mojom.LargeMessageTestInterface = class {
...
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTest_Fetch_ParamsSpec');
/**
...
goog.provide('mojo.test.remoteUnittest.mojom.SharedRemoteSyncTest_Fetch_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTest_ProcessData_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTest_ProcessData_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTest_ProcessLotsOfData_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTest_ProcessLotsOfData_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTest_GetLotsOfData_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.remoteUnittest.mojom.LargeMessageTest_GetLotsOfData_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
