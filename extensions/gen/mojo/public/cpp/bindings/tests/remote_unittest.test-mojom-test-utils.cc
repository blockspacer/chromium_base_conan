// mojo/public/cpp/bindings/tests/remote_unittest.test-mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/remote_unittest.test-mojom-test-utils.h"
...
void LargeMessageTestInterceptorForTesting::ProcessData(const std::vector<uint8_t>& data, ProcessDataCallback callback) {
  GetForwardingInterface()->ProcessData(std::move(data), std::move(callback));
}
void LargeMessageTestInterceptorForTesting::ProcessLotsOfData(const std::vector<uint8_t>& data, ProcessLotsOfDataCallback callback) {
...
void LargeMessageTestAsyncWaiter::ProcessData(
    const std::vector<uint8_t>& data, uint64_t* out_data_size) {
  base::RunLoop loop;
...
void LargeMessageTestAsyncWaiter::GetLotsOfData(
    uint64_t data_size, std::vector<uint8_t>* out_data) {
  base::RunLoop loop;
