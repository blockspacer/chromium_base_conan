// mojo/public/cpp/bindings/tests/binder_map_unittest.test-mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/binder_map_unittest.test-mojom-blink-import-headers.h"
...
bool TestInterface1RequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::binder_map_unittest::mojom::blink::TestInterface1::Name_;
...
bool TestInterface2RequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::binder_map_unittest::mojom::blink::TestInterface2::Name_;
  return mojo::internal::ValidateRequestGeneric(message, name, {});
}
