// mojo/public/cpp/bindings/tests/remote_unittest.test-mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_H_
#define MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_H_
...
#include "mojo/public/cpp/bindings/tests/remote_unittest.test-mojom-forward.h"
#include <string>
#include <vector>
...
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessData
  virtual bool ProcessData(const std::vector<uint8_t>& data, uint64_t* out_data_size);

  using ProcessDataCallback = base::OnceCallback<void(uint64_t)>;
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessData
  virtual void ProcessData(const std::vector<uint8_t>& data, ProcessDataCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessLotsOfData
  virtual bool ProcessLotsOfData(const std::vector<uint8_t>& data, uint64_t* out_data_size);

  using ProcessLotsOfDataCallback = base::OnceCallback<void(uint64_t)>;
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessLotsOfData
  virtual void ProcessLotsOfData(const std::vector<uint8_t>& data, ProcessLotsOfDataCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.GetLotsOfData
  virtual bool GetLotsOfData(uint64_t data_size, std::vector<uint8_t>* out_data);

  using GetLotsOfDataCallback = base::OnceCallback<void(const std::vector<uint8_t>&)>;
...
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessData
  bool ProcessData(const std::vector<uint8_t>& data, uint64_t* out_data_size) final;
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessData
  void ProcessData(const std::vector<uint8_t>& data, ProcessDataCallback callback) final;
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessLotsOfData
  bool ProcessLotsOfData(const std::vector<uint8_t>& data, uint64_t* out_data_size) final;
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.ProcessLotsOfData
  void ProcessLotsOfData(const std::vector<uint8_t>& data, ProcessLotsOfDataCallback callback) final;
  
// @generated_from: mojo.test.remote_unittest.mojom.LargeMessageTest.GetLotsOfData
  bool GetLotsOfData(uint64_t data_size, std::vector<uint8_t>* out_data) final;
...
#endif  // MOJO_PUBLIC_CPP_BINDINGS_TESTS_REMOTE_UNITTEST_TEST_MOJOM_H_

/* Metadata comment

...

...
dGVzdC5tb2pvbS5MYXJnZU1lc3NhZ2VUZXN0LlByb2Nlc3NEYXRhIn19LCB7ImVuZCI6IDQ1OTUs
ICJiZWdpbiI6IDQ1ODQsICJlZGdlIjogIiUva3l0aGUvZWRnZS9nZW5lcmF0ZXMiLCAidHlwZSI6
...

...
T2ZEYXRhIn19LCB7ImVuZCI6IDU1MDUsICJiZWdpbiI6IDU0OTIsICJlZGdlIjogIiUva3l0aGUv
...
LkxhcmdlTWVzc2FnZVRlc3QuR2V0TG90c09mRGF0YSJ9fSwgeyJlbmQiOiA1NzYxLCAiYmVnaW4i
OiA1NzQ4LCAiZWRnZSI6ICIlL2t5dGhlL2VkZ2UvZ2VuZXJhdGVzIiwgInR5cGUiOiAiYW5jaG9y
...
fX0sIHsiZW5kIjogNjIwMSwgImJlZ2luIjogNjE5NiwgImVkZ2UiOiAiJS9reXRoZS9lZGdlL2dl
...

...
bS5MYXJnZU1lc3NhZ2VUZXN0LlByb2Nlc3NEYXRhIn19LCB7ImVuZCI6IDcxNDAsICJiZWdpbiI6
IDcxMjMsICJlZGdlIjogIiUva3l0aGUvZWRnZS9nZW5lcmF0ZXMiLCAidHlwZSI6ICJhbmNob3Jf
...
dGEifX0sIHsiZW5kIjogNzMyMSwgImJlZ2luIjogNzMwNCwgImVkZ2UiOiAiJS9reXRoZS9lZGdl
...

