// mojo/public/cpp/bindings/tests/flush_async_unittest.test-mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/flush_async_unittest.test-mojom-test-utils.h"
...
void WriterInterceptorForTesting::Put(const std::string& key, const std::string& value) {
...
void KeyValueStoreAsyncWaiter::GetSnapshot(
    base::flat_map<std::string, std::string>* out_entries) {
  base::RunLoop loop;
  proxy_->GetSnapshot(
      base::BindOnce(
          [](base::RunLoop* loop,
             base::flat_map<std::string, std::string>* out_entries
,
             const base::flat_map<std::string, std::string>& entries) {*out_entries = std::move(entries);
            loop->Quit();
          },
          &loop,
          out_entries));
