// mojo/public/cpp/bindings/tests/extra_cpp_template_unittest.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/extra_cpp_template_unittest.test-mojom-import-headers.h"
...
bool ExtraCppInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::extra_cpp_template_unittest::mojom::ExtraCppInterface::Name_;
