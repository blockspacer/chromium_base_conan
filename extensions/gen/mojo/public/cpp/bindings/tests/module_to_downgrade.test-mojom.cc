// mojo/public/cpp/bindings/tests/module_to_downgrade.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/cpp/bindings/tests/module_to_downgrade.test-mojom-import-headers.h"
...
bool FooRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::mojom_types_downgrader_unittest::mojom::Foo::Name_;
...
bool DowngradedTestInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::mojom_types_downgrader_unittest::mojom::DowngradedTestInterface::Name_;
