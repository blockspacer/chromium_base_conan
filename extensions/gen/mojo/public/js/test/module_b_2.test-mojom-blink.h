// mojo/public/js/test/module_b_2.test-mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_JS_TEST_MODULE_B_2_TEST_MOJOM_BLINK_H_
#define MOJO_PUBLIC_JS_TEST_MODULE_B_2_TEST_MOJOM_BLINK_H_
...
#include "mojo/public/js/test/module_b_2.test-mojom-blink-forward.h"
...
// @generated_from: module_b.TestInterface.PassA1
  virtual void PassA1(::module_a::blink::TestStructA1Ptr a1) = 0;

  
// @generated_from: module_b.TestInterface.PassB1
  virtual void PassB1(::module_b::blink::TestStructB1Ptr b1) = 0;
...
// @generated_from: module_b.TestInterface.PassA1
  void PassA1(::module_a::blink::TestStructA1Ptr a1) final;
  
// @generated_from: module_b.TestInterface.PassB1
  void PassB1(::module_b::blink::TestStructB1Ptr b1) final;
...
class  TestStructB2 {
 public:
  ...
  TestStructB2(
      ::module_a::blink::TestStructA1Ptr a1,
      ::module_a::blink::TestStructA2Ptr a2,
      TestStructB2Ptr b2);
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TestStructB2::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::module_b::blink::TestStructB2::DataView,
                                         ::module_b::blink::TestStructB2Ptr> {
  static bool IsNull(const ::module_b::blink::TestStructB2Ptr& input) { return !input; }
  static void SetToNull(::module_b::blink::TestStructB2Ptr* output) { output->reset(); }

  static const decltype(::module_b::blink::TestStructB2::a1)& a1(
      const ::module_b::blink::TestStructB2Ptr& input) {
    return input->a1;
  }

  static const decltype(::module_b::blink::TestStructB2::a2)& a2(
      const ::module_b::blink::TestStructB2Ptr& input) {
    return input->a2;
  }

  static const decltype(::module_b::blink::TestStructB2::b2)& b2(
      const ::module_b::blink::TestStructB2Ptr& input) {
    return input->b2;
  }

  static bool Read(::module_b::blink::TestStructB2::DataView input, ::module_b::blink::TestStructB2Ptr* output);
};

}  // namespace mojo

#endif  // MOJO_PUBLIC_JS_TEST_MODULE_B_2_TEST_MOJOM_BLINK_H_

/* Metadata comment

...
ICJtb2R1bGVfYi5UZXN0SW50ZXJmYWNlLlBhc3NCMSJ9fSwgeyJlbmQiOiAzMTI5LCAiYmVnaW4i
OiAzMTIzLCAiZWRnZSI6ICIlL2t5dGhlL2VkZ2UvZ2VuZXJhdGVzIiwgInR5cGUiOiAiYW5jaG9y
...
X2IuVGVzdEludGVyZmFjZS5QYXNzQjIifX0sIHsiZW5kIjogMzQ1MSwgImJlZ2luIjogMzQ0NSwg
...
bnRlcmZhY2UuUGFzc0ExIn19LCB7ImVuZCI6IDM1NjQsICJiZWdpbiI6IDM1NTgsICJlZGdlIjog
...
LlBhc3NCMSJ9fSwgeyJlbmQiOiAzNjc3LCAiYmVnaW4iOiAzNjcxLCAiZWRnZSI6ICIlL2t5dGhl
...
fX0sIHsiZW5kIjogNTI0NSwgImJlZ2luIjogNTIzMywgImVkZ2UiOiAiJS9reXRoZS9lZGdlL2dl
...
b20iLCAic2lnbmF0dXJlIjogIm1vZHVsZV9iLlRlc3RTdHJ1Y3RCMiJ9fSwgeyJlbmQiOiA4OTcz
LCAiYmVnaW4iOiA4OTcxLCAiZWRnZSI6ICIlL2t5dGhlL2VkZ2UvZ2VuZXJhdGVzIiwgInR5cGUi
...
OiAibW9kdWxlX2IuVGVzdFN0cnVjdEIyLmExIn19LCB7ImVuZCI6IDkwNjIsICJiZWdpbiI6IDkw
...
ZXN0U3RydWN0QjIuYTIifX0sIHsiZW5kIjogOTEzMiwgImJlZ2luIjogOTEzMCwgImVkZ2UiOiAi
