// mojo/public/js/test/module_b_1.test-mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_JS_TEST_MODULE_B_1_TEST_MOJOM_BLINK_H_
#define MOJO_PUBLIC_JS_TEST_MODULE_B_1_TEST_MOJOM_BLINK_H_
...
#include "mojo/public/js/test/module_b_1.test-mojom-blink-forward.h"
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TestStructB1::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::module_b::blink::TestStructB1::DataView,
                                         ::module_b::blink::TestStructB1Ptr> {
  static bool IsNull(const ::module_b::blink::TestStructB1Ptr& input) { return !input; }
  static void SetToNull(::module_b::blink::TestStructB1Ptr* output) { output->reset(); }

  static decltype(::module_b::blink::TestStructB1::x) x(
      const ::module_b::blink::TestStructB1Ptr& input) {
    return input->x;
  }

  static decltype(::module_b::blink::TestStructB1::y) y(
      const ::module_b::blink::TestStructB1Ptr& input) {
    return input->y;
  }

  static bool Read(::module_b::blink::TestStructB1::DataView input, ::module_b::blink::TestStructB1Ptr* output);
};

}  // namespace mojo

#endif  // MOJO_PUBLIC_JS_TEST_MODULE_B_1_TEST_MOJOM_BLINK_H_

/* Metadata comment

...
YXR1cmUiOiAibW9kdWxlX2IuVGVzdFN0cnVjdEIxLngifX0sIHsiZW5kIjogNTIxMiwgImJlZ2lu
IjogNTIxMSwgImVkZ2UiOiAiJS9reXRoZS9lZGdlL2dlbmVyYXRlcyIsICJ0eXBlIjogImFuY2hv
