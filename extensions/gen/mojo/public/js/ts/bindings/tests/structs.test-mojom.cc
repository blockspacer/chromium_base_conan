// mojo/public/js/ts/bindings/tests/structs.test-mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/js/ts/bindings/tests/structs.test-mojom.h"
...
#include "mojo/public/js/ts/bindings/tests/structs.test-mojom-import-headers.h"


#ifndef MOJO_PUBLIC_JS_TS_BINDINGS_TESTS_STRUCTS_TEST_MOJOM_JUMBO_H_
#define MOJO_PUBLIC_JS_TS_BINDINGS_TESTS_STRUCTS_TEST_MOJOM_JUMBO_H_
#endif
namespace mojo {
namespace tstest {
...
size_t StructMemberStruct::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->empty_struct);
  return seed;
}
...
NoDefaultValuesStruct::NoDefaultValuesStruct(
    ...
    const std::string& string_value_in)
...
size_t NoDefaultValuesStruct::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->bool_value);
  seed = mojo::internal::Hash(seed, this->int8_value);
  seed = mojo::internal::Hash(seed, this->uint8_value);
  seed = mojo::internal::Hash(seed, this->int16_value);
  seed = mojo::internal::Hash(seed, this->uint16_value);
  seed = mojo::internal::Hash(seed, this->int32_value);
  seed = mojo::internal::Hash(seed, this->uint32_value);
  seed = mojo::internal::Hash(seed, this->int64_value);
  seed = mojo::internal::Hash(seed, this->uint64_value);
  seed = mojo::internal::Hash(seed, this->float_value);
  seed = mojo::internal::Hash(seed, this->double_value);
  seed = mojo::internal::Hash(seed, this->string_value);
  return seed;
}
...
// static
bool StructTraits<::mojo::tstest::EmptyStruct::DataView, ::mojo::tstest::EmptyStructPtr>::Read(
    ::mojo::tstest::EmptyStruct::DataView input,
    ::mojo::tstest::EmptyStructPtr* output) {
  bool success = true;
  ::mojo::tstest::EmptyStructPtr result(::mojo::tstest::EmptyStruct::New());
...
// static
bool StructTraits<::mojo::tstest::StructMemberStruct::DataView, ::mojo::tstest::StructMemberStructPtr>::Read(
    ::mojo::tstest::StructMemberStruct::DataView input,
    ::mojo::tstest::StructMemberStructPtr* output) {
  bool success = true;
  ::mojo::tstest::StructMemberStructPtr result(::mojo::tstest::StructMemberStruct::New());
...
// static
bool StructTraits<::mojo::tstest::IntStruct::DataView, ::mojo::tstest::IntStructPtr>::Read(
    ::mojo::tstest::IntStruct::DataView input,
    ::mojo::tstest::IntStructPtr* output) {
  bool success = true;
  ::mojo::tstest::IntStructPtr result(::mojo::tstest::IntStruct::New());
...
// static
bool StructTraits<::mojo::tstest::BoolStruct::DataView, ::mojo::tstest::BoolStructPtr>::Read(
    ::mojo::tstest::BoolStruct::DataView input,
    ::mojo::tstest::BoolStructPtr* output) {
  bool success = true;
  ::mojo::tstest::BoolStructPtr result(::mojo::tstest::BoolStruct::New());
...
// static
bool StructTraits<::mojo::tstest::NoDefaultValuesStruct::DataView, ::mojo::tstest::NoDefaultValuesStructPtr>::Read(
    ::mojo::tstest::NoDefaultValuesStruct::DataView input,
    ::mojo::tstest::NoDefaultValuesStructPtr* output) {
  bool success = true;
  ::mojo::tstest::NoDefaultValuesStructPtr result(::mojo::tstest::NoDefaultValuesStruct::New());
