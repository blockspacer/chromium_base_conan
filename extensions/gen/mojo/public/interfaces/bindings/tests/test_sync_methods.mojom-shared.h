// mojo/public/interfaces/bindings/tests/test_sync_methods.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
using TestSyncPrimaryPtrDataView =
    mojo::InterfacePtrDataView<TestSyncPrimaryInterfaceBase>;
using TestSyncPrimaryRequestDataView =
    mojo::InterfaceRequestDataView<TestSyncPrimaryInterfaceBase>;
using TestSyncPrimaryAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<TestSyncPrimaryInterfaceBase>;
using TestSyncPrimaryAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<TestSyncPrimaryInterfaceBase>;
