// mojo/public/interfaces/bindings/tests/math_calculator.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool CalculatorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::math::Calculator::Name_;
