// mojo/public/interfaces/bindings/tests/validation_test_associated_interfaces.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/validation_test_associated_interfaces.mojom-blink-import-headers.h"
#include "mojo/public/cpp/bindings/lib/wtf_serialization.h"


#ifndef MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_VALIDATION_TEST_ASSOCIATED_INTERFACES_MOJOM_BLINK_JUMBO_H_
#define MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_VALIDATION_TEST_ASSOCIATED_INTERFACES_MOJOM_BLINK_JUMBO_H_
#endif
namespace mojo {
namespace test {
namespace blink {
...
bool InterfaceXRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::InterfaceX::Name_;
...
void AssociatedConformanceTestInterfaceProxy::Method3(
    WTF::Vector<::mojo::PendingAssociatedRemote<InterfaceX>> in_param0) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("param0"), in_param0, 
                        "<value of type WTF::Vector<::mojo::PendingAssociatedRemote<InterfaceX>>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
std::move(p_param0));
    ...
    case internal::kAssociatedConformanceTestInterface_Method3_Name: {
      ...
      bool success = true;
      WTF::Vector<::mojo::PendingAssociatedRemote<InterfaceX>> p_param0{};
...
bool AssociatedConformanceTestInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::AssociatedConformanceTestInterface::Name_;
