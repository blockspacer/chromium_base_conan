// mojo/public/interfaces/bindings/tests/test_associated_interfaces.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_TEST_ASSOCIATED_INTERFACES_MOJOM_BLINK_TEST_UTILS_H_
#define MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_TEST_ASSOCIATED_INTERFACES_MOJOM_BLINK_TEST_UTILS_H_
...
class  StringSenderInterceptorForTesting : public StringSender {
  ...
  void Echo(const WTF::String& value, EchoCallback callback) override;
  void Send(const WTF::String& value) override;
};
...
class  AssociatedPingProviderInterceptorForTesting : public AssociatedPingProvider {
  ...
  void GetPing(::mojo::PendingAssociatedReceiver<::mojo::test::blink::PingService> receiver) override;
};
...
#endif  // MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_TEST_ASSOCIATED_INTERFACES_MOJOM_BLINK_TEST_UTILS_H_