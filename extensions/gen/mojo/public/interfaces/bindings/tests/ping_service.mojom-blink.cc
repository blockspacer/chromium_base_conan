// mojo/public/interfaces/bindings/tests/ping_service.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool PingServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::PingService::Name_;
...
bool EchoServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::EchoService::Name_;
...
bool HandleTrampolineRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::HandleTrampoline::Name_;
