// mojo/public/interfaces/bindings/tests/new_endpoint_types.test-mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/new_endpoint_types.test-mojom-blink-import-headers.h"
#include "mojo/public/cpp/bindings/lib/wtf_serialization.h"


#ifndef MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_NEW_ENDPOINT_TYPES_TEST_MOJOM_BLINK_JUMBO_H_
#define MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_NEW_ENDPOINT_TYPES_TEST_MOJOM_BLINK_JUMBO_H_
#endif
namespace mojo {
namespace test {
...
bool WidgetObserverRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::new_endpoint_types::mojom::blink::WidgetObserver::Name_;
...
bool WidgetRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::new_endpoint_types::mojom::blink::Widget::Name_;
...
bool WidgetClientRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::new_endpoint_types::mojom::blink::WidgetClient::Name_;
...
bool WidgetFactoryRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::new_endpoint_types::mojom::blink::WidgetFactory::Name_;
...
bool PingerRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::new_endpoint_types::mojom::blink::Pinger::Name_;
...
bool AssociatedPingerHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::new_endpoint_types::mojom::blink::AssociatedPingerHost::Name_;
