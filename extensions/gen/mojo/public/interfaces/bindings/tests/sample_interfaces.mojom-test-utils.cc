// mojo/public/interfaces/bindings/tests/sample_interfaces.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/sample_interfaces.mojom-test-utils.h"
...
void ProviderInterceptorForTesting::EchoString(const std::string& a, EchoStringCallback callback) {
  GetForwardingInterface()->EchoString(std::move(a), std::move(callback));
}
void ProviderInterceptorForTesting::EchoStrings(const std::string& a, const std::string& b, EchoStringsCallback callback) {
  ...
  proxy_->EchoString(std::move(a),
      base::BindOnce(
          [](base::RunLoop* loop,
             std::string* out_a
,
             const std::string& a) {*out_a = std::move(a);
            loop->Quit();
          },
          &loop,
          out_a));
...
,
             const std::string& a,
             const std::string& b) {*out_a = std::move(a);*out_b = std::move(b);
            loop->Quit();
          },
          &loop,
          out_a,
