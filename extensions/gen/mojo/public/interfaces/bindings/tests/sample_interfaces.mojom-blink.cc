// mojo/public/interfaces/bindings/tests/sample_interfaces.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool PingTestRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::sample::blink::PingTest::Name_;
...
bool ProviderRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::sample::blink::Provider::Name_;
...
bool IntegerAccessorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::sample::blink::IntegerAccessor::Name_;
...
bool InterfaceFactoryRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::sample::blink::InterfaceFactory::Name_;
