// mojo/public/interfaces/bindings/tests/echo.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/echo.mojom-blink-import-headers.h"
...
void EchoProxy::EchoPoint(
    ::test::echo_import::mojom::blink::PointPtr in_point, EchoPointCallback callback) {
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("point"), in_point, 
                        "<value of type ::test::echo_import::mojom::blink::PointPtr>");
   });
#endif
...
class Echo_EchoPoint_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::test::echo_import::mojom::blink::PointPtr in_result);
...
bool Echo_EchoPoint_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::test::echo_import::mojom::blink::PointPtr p_result{};
...
bool EchoStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kEcho_EchoPoint_Name: {
      ...
      bool success = true;
      ::test::echo_import::mojom::blink::PointPtr p_point{};
...
bool EchoRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::test::echo::mojom::blink::Echo::Name_;
