// mojo/public/interfaces/bindings/tests/test_data_view.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/test_data_view.mojom-import-headers.h"
...
TestStruct::TestStruct(
    ...
    std::vector<bool> f_bool_array_in,
    std::vector<int32_t> f_int32_array_in,
    std::vector<TestEnum> f_enum_array_in,
    std::vector<::mojo::PendingRemote<TestInterface>> f_interface_array_in,
    std::vector<std::vector<int32_t>> f_nested_array_in,
    std::vector<NestedStructPtr> f_struct_array_in,
    std::vector<TestUnionPtr> f_union_array_in,
    const base::flat_map<std::string, int32_t>& f_map_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const std::vector<TestEnum>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::mojo::PendingRemote<TestInterface>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<NestedStructPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<TestUnionPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool TestInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::data_view::TestInterface::Name_;
...
// static
bool StructTraits<::mojo::test::data_view::NestedStruct::DataView, ::mojo::test::data_view::NestedStructPtr>::Read(
    ::mojo::test::data_view::NestedStruct::DataView input,
    ::mojo::test::data_view::NestedStructPtr* output) {
  bool success = true;
  ::mojo::test::data_view::NestedStructPtr result(::mojo::test::data_view::NestedStruct::New());
...
// static
bool StructTraits<::mojo::test::data_view::TestStruct::DataView, ::mojo::test::data_view::TestStructPtr>::Read(
    ::mojo::test::data_view::TestStruct::DataView input,
    ::mojo::test::data_view::TestStructPtr* output) {
  bool success = true;
  ::mojo::test::data_view::TestStructPtr result(::mojo::test::data_view::TestStruct::New());
...
// static
bool UnionTraits<::mojo::test::data_view::TestUnion::DataView, ::mojo::test::data_view::TestUnionPtr>::Read(
    ::mojo::test::data_view::TestUnion::DataView input,
    ::mojo::test::data_view::TestUnionPtr* output) {
  using UnionType = ::mojo::test::data_view::TestUnion;
