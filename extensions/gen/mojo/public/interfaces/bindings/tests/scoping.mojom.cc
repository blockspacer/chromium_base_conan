// mojo/public/interfaces/bindings/tests/scoping.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool ARequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::A::Name_;
...
bool BRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::B::Name_;
...
bool CRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::C::Name_;
