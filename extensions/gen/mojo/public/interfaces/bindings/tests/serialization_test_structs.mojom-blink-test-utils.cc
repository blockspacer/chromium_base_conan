// mojo/public/interfaces/bindings/tests/serialization_test_structs.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
