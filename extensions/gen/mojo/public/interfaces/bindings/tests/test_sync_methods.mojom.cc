// mojo/public/interfaces/bindings/tests/test_sync_methods.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/test_sync_methods.mojom-import-headers.h"
...
bool TestSyncCodeGenerationRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::TestSyncCodeGeneration::Name_;
...
bool TestSyncRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::TestSync::Name_;
...
bool TestSyncPrimaryRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::TestSyncPrimary::Name_;
