// mojo/public/interfaces/bindings/tests/test_unions.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::Optional<WTF::Vector<PodUnionPtr>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::Optional<WTF::Vector<DummyStructPtr>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::Optional<WTF::HashMap<WTF::String, PodUnionPtr>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::imported::blink::PointOrShapePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t UnionWithStringForFirstField::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::S:
      return mojo::internal::WTFHash(seed, data_.s);
    case Tag::I:
      return mojo::internal::WTFHash(seed, data_.i);
    default:
      NOTREACHED();
      return seed;
  }
...
bool SmallCacheRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::SmallCache::Name_;
...
bool UnionInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::UnionInterface::Name_;
...
// static
bool UnionTraits<::mojo::test::blink::UnionWithStringForFirstField::DataView, ::mojo::test::blink::UnionWithStringForFirstFieldPtr>::Read(
    ::mojo::test::blink::UnionWithStringForFirstField::DataView input,
    ::mojo::test::blink::UnionWithStringForFirstFieldPtr* output) {
  using UnionType = ::mojo::test::blink::UnionWithStringForFirstField;
  using Tag = UnionType::Tag;
