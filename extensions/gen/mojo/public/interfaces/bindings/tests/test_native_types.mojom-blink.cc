// mojo/public/interfaces/bindings/tests/test_native_types.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void PickleContainer::WriteIntoTracedValue(perfetto::TracedValue context) const {
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::mojo::test::PickledStructBlink>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "f_enum"), this->f_enum,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo::test::PickledEnumBlink>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("pickles"), in_pickles, 
                        "<value of type WTF::Vector<::mojo::test::PickledStructBlink>>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("pickle_arrays"), in_pickle_arrays, 
                        "<value of type WTF::Vector<WTF::Vector<::mojo::test::PickledStructBlink>>>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool PicklePasserRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::PicklePasser::Name_;
...
bool RectServiceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::RectService::Name_;
...
void NativeTypeTesterProxy::PassNativeStruct(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("s"), in_s, 
                        "<value of type TestNativeStructMojomPtr>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
void NativeTypeTesterProxy::PassNativeStructWithAttachments(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("s"), in_s, 
                        "<value of type TestNativeStructWithAttachmentsMojomPtr>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool NativeTypeTesterRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::NativeTypeTester::Name_;
