// mojo/public/interfaces/bindings/tests/no_module.mojom-blink-forward.h is auto generated by mojom_bindings_generator.py, do not edit
...
namespace blink {
using EnumWithoutModule = EnumWithoutModule;
