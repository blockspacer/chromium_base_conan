// mojo/public/interfaces/bindings/tests/validation_test_interfaces.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/validation_test_interfaces.mojom-test-utils.h"
...
void ConformanceTestInterfaceInterceptorForTesting::Method3(const std::vector<bool>& param0) {
  GetForwardingInterface()->Method3(std::move(param0));
}
void ConformanceTestInterfaceInterceptorForTesting::Method4(StructCPtr param0, const std::vector<uint8_t>& param1) {
...
void ConformanceTestInterfaceInterceptorForTesting::Method6(const std::vector<std::vector<uint8_t>>& param0) {
  GetForwardingInterface()->Method6(std::move(param0));
}
void ConformanceTestInterfaceInterceptorForTesting::Method7(StructFPtr param0, const std::vector<base::Optional<std::vector<uint8_t>>>& param1) {
  GetForwardingInterface()->Method7(std::move(param0), std::move(param1));
}
void ConformanceTestInterfaceInterceptorForTesting::Method8(const std::vector<base::Optional<std::vector<std::string>>>& param0) {
  GetForwardingInterface()->Method8(std::move(param0));
}
void ConformanceTestInterfaceInterceptorForTesting::Method9(base::Optional<std::vector<std::vector<::mojo::ScopedHandle>>> param0) {
  GetForwardingInterface()->Method9(std::move(param0));
}
void ConformanceTestInterfaceInterceptorForTesting::Method10(const base::flat_map<std::string, uint8_t>& param0) {
...
void ConformanceTestInterfaceInterceptorForTesting::Method15(const base::Optional<std::vector<EnumA>>& param0, const base::Optional<std::vector<EnumB>>& param1) {
  GetForwardingInterface()->Method15(std::move(param0), std::move(param1));
}
void ConformanceTestInterfaceInterceptorForTesting::Method16(const base::Optional<base::flat_map<EnumA, EnumA>>& param0) {
  GetForwardingInterface()->Method16(std::move(param0));
}
void ConformanceTestInterfaceInterceptorForTesting::Method17(std::vector<::mojo::PendingRemote<InterfaceA>> param0) {
...
void ConformanceTestInterfaceInterceptorForTesting::Method20(base::flat_map<StructBPtr, uint8_t> param0) {
...
void IntegrationTestInterfaceAsyncWaiter::Method0(
  ...
  proxy_->Method0(std::move(param0),
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<uint8_t>* out_param0
,
             const std::vector<uint8_t>& param0) {*out_param0 = std::move(param0);
            loop->Quit();
          },
          &loop,
          out_param0));
