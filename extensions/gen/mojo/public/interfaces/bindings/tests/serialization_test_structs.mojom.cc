// mojo/public/interfaces/bindings/tests/serialization_test_structs.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void Struct4::WriteIntoTracedValue(perfetto::TracedValue context) const {
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "data"), this->data,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<Struct1Ptr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
