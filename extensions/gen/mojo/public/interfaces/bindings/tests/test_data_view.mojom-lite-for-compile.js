// mojo/public/interfaces/bindings/tests/test_data_view.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('mojo.test.dataView.TestEnum');
goog.provide('mojo.test.dataView.TestEnumSpec');
/**
...
goog.provide('mojo.test.dataView.TestInterfaceReceiver');
goog.provide('mojo.test.dataView.TestInterfaceCallbackRouter');
goog.provide('mojo.test.dataView.TestInterfaceInterface');
goog.provide('mojo.test.dataView.TestInterfaceRemote');
goog.provide('mojo.test.dataView.TestInterfacePendingReceiver');
...
/** @interface */
mojo.test.dataView.TestInterfaceInterface = class {
...
goog.provide('mojo.test.dataView.NestedStructSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.dataView.TestNativeStructSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.dataView.TestStructSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.dataView.TestInterface_Echo_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.dataView.TestInterface_Echo_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojo.test.dataView.TestUnionSpec');
/**
 * @const { {$:!mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('mojo.test.dataView.TestUnion');
