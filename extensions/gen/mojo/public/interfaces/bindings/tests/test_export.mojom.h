// mojo/public/interfaces/bindings/tests/test_export.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_TEST_EXPORT_MOJOM_H_
#define MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_TEST_EXPORT_MOJOM_H_
...
#include "mojo/public/interfaces/bindings/tests/test_export.mojom-forward.h"
#include <string>
#include <vector>
...
class MOJO_TEST_EXPORT ExportedInterface
...
// @generated_from: mojo.test.test_export.ExportedInterface
class MOJO_TEST_EXPORT ExportedInterfaceProxy
...
class MOJO_TEST_EXPORT ExportedInterfaceStubDispatch {
 public:
...
class MOJO_TEST_EXPORT ExportedInterfaceRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class MOJO_TEST_EXPORT StringPair {
 public:
  template <typename T>
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StringPair::DataView, std::vector<uint8_t>>(input);
  }
...
class MOJO_TEST_EXPORT StringPairContainer {
 public:
  template <typename T>
  ...
  explicit StringPairContainer(
      std::vector<StringPairPtr> pairs);
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StringPairContainer::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct MOJO_TEST_EXPORT StructTraits<::mojo::test::test_export::StringPair::DataView,
                                         ::mojo::test::test_export::StringPairPtr> {
  static bool IsNull(const ::mojo::test::test_export::StringPairPtr& input) { return !input; }
  static void SetToNull(::mojo::test::test_export::StringPairPtr* output) { output->reset(); }

  static const decltype(::mojo::test::test_export::StringPair::s1)& s1(
      const ::mojo::test::test_export::StringPairPtr& input) {
    return input->s1;
  }

  static const decltype(::mojo::test::test_export::StringPair::s2)& s2(
      const ::mojo::test::test_export::StringPairPtr& input) {
    return input->s2;
  }

  static bool Read(::mojo::test::test_export::StringPair::DataView input, ::mojo::test::test_export::StringPairPtr* output);
};


template <>
struct MOJO_TEST_EXPORT StructTraits<::mojo::test::test_export::StringPairContainer::DataView,
                                         ::mojo::test::test_export::StringPairContainerPtr> {
  static bool IsNull(const ::mojo::test::test_export::StringPairContainerPtr& input) { return !input; }
  static void SetToNull(::mojo::test::test_export::StringPairContainerPtr* output) { output->reset(); }

  static const decltype(::mojo::test::test_export::StringPairContainer::pairs)& pairs(
      const ::mojo::test::test_export::StringPairContainerPtr& input) {
    return input->pairs;
  }

  static bool Read(::mojo::test::test_export::StringPairContainer::DataView input, ::mojo::test::test_export::StringPairContainerPtr* output);
};

}  // namespace mojo

#endif  // MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_TEST_EXPORT_MOJOM_H_

/* Metadata comment

...
aXIifX0sIHsiZW5kIjogODExMywgImJlZ2luIjogODExMSwgImVkZ2UiOiAiJS9reXRoZS9lZGdl
...
In19LCB7ImVuZCI6IDgxOTAsICJiZWdpbiI6IDgxODgsICJlZGdlIjogIiUva3l0aGUvZWRnZS9n
...
fSwgeyJlbmQiOiA5MjU2LCAiYmVnaW4iOiA5MjM3LCAiZWRnZSI6ICIlL2t5dGhlL2VkZ2UvZ2Vu
...
ZXIifX0sIHsiZW5kIjogMTMwNjksICJiZWdpbiI6IDEzMDY0LCAiZWRnZSI6ICIlL2t5dGhlL2Vk
