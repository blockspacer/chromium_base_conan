// mojo/public/interfaces/bindings/tests/test_wtf_types.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/test_wtf_types.mojom-blink-import-headers.h"
...
TestWTFCodeGeneration::TestWTFCodeGeneration(
    ...
    const WTF::String& nullable_str_in,
    WTF::Vector<WTF::String> strs_in,
    WTF::Vector<WTF::String> nullable_strs_in,
    WTF::Vector<WTF::Vector<int32_t>> arrays_in,
    WTF::Vector<bool> bools_in,
    WTF::Vector<::mojo::ScopedMessagePipeHandle> handles_in,
    const WTF::HashMap<WTF::String, WTF::String>& str_map_in,
    const WTF::HashMap<int32_t, WTF::Vector<int32_t>>& array_map_in,
    WTF::HashMap<int32_t, ::mojo::ScopedMessagePipeHandle> handle_map_in,
    WTF::Vector<WTF::HashMap<WTF::String, WTF::String>> str_maps_in)
    : str(std::move(str_in)),
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const WTF::HashMap<int32_t, WTF::Vector<int32_t>>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type WTF::HashMap<int32_t, ::mojo::ScopedMessagePipeHandle>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const WTF::Vector<WTF::HashMap<WTF::String, WTF::String>>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t TestWTFStruct::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->integer);
  return seed;
}
...
TestWTFStructWrapper::TestWTFStructWrapper(
    ...
    WTF::Vector<TestWTFStructPtr> array_struct_in,
    WTF::HashMap<TestWTFStructPtr, TestWTFStructPtr> map_struct_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type WTF::Vector<TestWTFStructPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type WTF::HashMap<TestWTFStructPtr, TestWTFStructPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void TestWTFCodeGeneration2::set_strs(
  ...
  if (tag_ == Tag::STRS) {
    *(data_.strs) = std::move(strs);
    ...
    DestroyActive();
    tag_ = Tag::STRS;
    data_.strs = new WTF::Vector<WTF::String>(
        std::move(strs));
  }
}
void TestWTFCodeGeneration2::set_str_map(
  ...
  if (tag_ == Tag::STR_MAP) {
    *(data_.str_map) = std::move(str_map);
    ...
    DestroyActive();
    tag_ = Tag::STR_MAP;
    data_.str_map = new WTF::HashMap<WTF::String, WTF::String>(
        std::move(str_map));
  }
}
...
void TestWTFProxy::EchoString(
    const WTF::String& in_str, EchoStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void TestWTFProxy::EchoStringArray(
    const base::Optional<WTF::Vector<WTF::String>>& in_arr, EchoStringArrayCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void TestWTFProxy::EchoStringMap(
    const base::Optional<WTF::HashMap<WTF::String, WTF::String>>& in_str_map, EchoStringMapCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("str_map"), in_str_map, 
                        "<value of type const base::Optional<WTF::HashMap<WTF::String, WTF::String>>&>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
class TestWTF_EchoStringArray_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const base::Optional<WTF::Vector<WTF::String>>& in_arr);
...
bool TestWTF_EchoStringArray_ForwardToCallback::Accept(
  ...
  bool success = true;
  base::Optional<WTF::Vector<WTF::String>> p_arr{};
...
class TestWTF_EchoStringMap_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const base::Optional<WTF::HashMap<WTF::String, WTF::String>>& in_str_map);
...
bool TestWTF_EchoStringMap_ForwardToCallback::Accept(
  ...
  bool success = true;
  base::Optional<WTF::HashMap<WTF::String, WTF::String>> p_str_map{};
...
bool TestWTFRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::TestWTF::Name_;
...
// static
bool StructTraits<::mojo::test::blink::TestWTFCodeGeneration::DataView, ::mojo::test::blink::TestWTFCodeGenerationPtr>::Read(
    ::mojo::test::blink::TestWTFCodeGeneration::DataView input,
    ::mojo::test::blink::TestWTFCodeGenerationPtr* output) {
  bool success = true;
  ::mojo::test::blink::TestWTFCodeGenerationPtr result(::mojo::test::blink::TestWTFCodeGeneration::New());
...
// static
bool StructTraits<::mojo::test::blink::TestWTFStruct::DataView, ::mojo::test::blink::TestWTFStructPtr>::Read(
    ::mojo::test::blink::TestWTFStruct::DataView input,
    ::mojo::test::blink::TestWTFStructPtr* output) {
  bool success = true;
  ::mojo::test::blink::TestWTFStructPtr result(::mojo::test::blink::TestWTFStruct::New());
...
// static
bool StructTraits<::mojo::test::blink::TestWTFStructWrapper::DataView, ::mojo::test::blink::TestWTFStructWrapperPtr>::Read(
    ::mojo::test::blink::TestWTFStructWrapper::DataView input,
    ::mojo::test::blink::TestWTFStructWrapperPtr* output) {
  bool success = true;
  ::mojo::test::blink::TestWTFStructWrapperPtr result(::mojo::test::blink::TestWTFStructWrapper::New());
...
// static
bool UnionTraits<::mojo::test::blink::TestWTFCodeGeneration2::DataView, ::mojo::test::blink::TestWTFCodeGeneration2Ptr>::Read(
    ::mojo::test::blink::TestWTFCodeGeneration2::DataView input,
    ::mojo::test::blink::TestWTFCodeGeneration2Ptr* output) {
  using UnionType = ::mojo::test::blink::TestWTFCodeGeneration2;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::STR: {
      WTF::String result_str;
    ...
    case Tag::STRS: {
      WTF::Vector<WTF::String> result_strs;
    ...
    case Tag::STR_MAP: {
      WTF::HashMap<WTF::String, WTF::String> result_str_map;
