// mojo/public/interfaces/bindings/tests/ping_service.mojom-blink-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/ping_service.mojom-blink-test-utils.h"
...
void EchoServiceInterceptorForTesting::Echo(const WTF::String& test_data, EchoCallback callback) {
...
void EchoServiceAsyncWaiter::Echo(
  ...
  proxy_->Echo(std::move(test_data),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::String* out_echo_data
,
             const WTF::String& echo_data) {*out_echo_data = std::move(echo_data);
            loop->Quit();
          },
          &loop,
          out_echo_data));
