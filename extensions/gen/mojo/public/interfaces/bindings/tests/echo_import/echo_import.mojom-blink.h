// mojo/public/interfaces/bindings/tests/echo_import/echo_import.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_ECHO_IMPORT_ECHO_IMPORT_MOJOM_BLINK_H_
#define MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_ECHO_IMPORT_ECHO_IMPORT_MOJOM_BLINK_H_
...
template <>
struct  StructTraits<::test::echo_import::mojom::blink::Point::DataView,
                                         ::test::echo_import::mojom::blink::PointPtr> {
  static bool IsNull(const ::test::echo_import::mojom::blink::PointPtr& input) { return !input; }
  static void SetToNull(::test::echo_import::mojom::blink::PointPtr* output) { output->reset(); }

  static decltype(::test::echo_import::mojom::blink::Point::x) x(
      const ::test::echo_import::mojom::blink::PointPtr& input) {
    return input->x;
  }

  static decltype(::test::echo_import::mojom::blink::Point::y) y(
      const ::test::echo_import::mojom::blink::PointPtr& input) {
    return input->y;
  }

  static bool Read(::test::echo_import::mojom::blink::Point::DataView input, ::test::echo_import::mojom::blink::PointPtr* output);
};

}  // namespace mojo

#endif  // MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_ECHO_IMPORT_ECHO_IMPORT_MOJOM_BLINK_H_

/* Metadata comment

...
OiA1MjI2LCAiYmVnaW4iOiA1MjI1LCAiZWRnZSI6ICIlL2t5dGhlL2VkZ2UvZ2VuZXJhdGVzIiwg
