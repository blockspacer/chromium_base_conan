// mojo/public/interfaces/bindings/tests/sample_factory.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void Request::WriteIntoTracedValue(perfetto::TracedValue context) const {
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::Optional<std::vector<::mojo::ScopedMessagePipeHandle>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "obj"), this->obj,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo::PendingRemote<::imported::ImportedInterface>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool NamedObjectRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::sample::NamedObject::Name_;
...
void FactoryProxy::RequestImportedInterface(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("obj"), in_obj, 
                        "<value of type ::mojo::PendingReceiver<::imported::ImportedInterface>>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool FactoryRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::sample::Factory::Name_;
