// mojo/public/interfaces/bindings/tests/sample_service.mojom-test-utils.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/interfaces/bindings/tests/sample_service.mojom-test-utils.h"
...
void PortInterceptorForTesting::PostMessageToPort(const std::string& message_text, ::mojo::PendingRemote<Port> port) {
