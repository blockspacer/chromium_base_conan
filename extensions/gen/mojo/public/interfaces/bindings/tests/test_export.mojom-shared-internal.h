// mojo/public/interfaces/bindings/tests/test_export.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
class COMPONENT_EXPORT(MOJOM_SHARED_MOJO_TEST_EXPORT) StringPairContainer_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<StringPairContainer_Data>;
...
struct StringPairContainer_UnserializedMessageContext
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<StringPairContainer_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
