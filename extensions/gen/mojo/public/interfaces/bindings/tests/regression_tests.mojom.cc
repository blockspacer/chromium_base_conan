// mojo/public/interfaces/bindings/tests/regression_tests.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool CheckMethodWithEmptyResponseRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::regression_tests::CheckMethodWithEmptyResponse::Name_;
...
bool CheckNameCollisionRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::regression_tests::CheckNameCollision::Name_;
...
bool HandlesNameCollisionInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::regression_tests::HandlesNameCollisionInterface::Name_;
