// mojo/public/interfaces/bindings/tests/test_bad_messages.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool TestBadMessagesRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::blink::TestBadMessages::Name_;
