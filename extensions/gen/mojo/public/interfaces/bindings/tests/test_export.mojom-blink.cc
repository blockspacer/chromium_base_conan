// mojo/public/interfaces/bindings/tests/test_export.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void StringPairContainer::WriteIntoTracedValue(perfetto::TracedValue context) const {
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "pairs"), this->pairs,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type WTF::Vector<StringPairPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool ExportedInterfaceRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::mojo::test::test_export::blink::ExportedInterface::Name_;
