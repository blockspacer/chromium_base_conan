...
#if (defined(USE_JEMALLOC) || BASIC_USE_JEMALLOC) && !BASIC_SANITIZE
#if defined(BASIC_ASSUME_NO_JEMALLOC)
#error \
    "Both USE_JEMALLOC/BASIC_USE_JEMALLOC and BASIC_ASSUME_NO_JEMALLOC defined"
#endif
...
#if defined(__APPLE__) && !defined(BASIC_HAVE_MALLOC_USABLE_SIZE)
