...
#define BASIC_KEEP [[gnu::section(".text.basic.keep")]]
#else
#define BASIC_KEEP
#endif

#if __GNUC__ && __linux__
#define BASIC_KEEP_DETAIL_ATTR_NAKED [[gnu::naked]]
#define BASIC_KEEP_DETAIL_ATTR_NOINLINE [[gnu::noinline]]
#else
#define BASIC_KEEP_DETAIL_ATTR_NAKED
#define BASIC_KEEP_DETAIL_ATTR_NOINLINE
#endif
...
BASIC_KEEP BASIC_KEEP_DETAIL_ATTR_NAKED static void keep_anchor() {}

class keep {
 public:
  //  must accept the anchor function as an argument
  BASIC_KEEP_DETAIL_ATTR_NOINLINE explicit keep(void (*)()) noexcept {}
};
...
template <typename... T>
BASIC_ATTR_WEAK BASIC_NOINLINE void keep_sink(T&&...) {}
