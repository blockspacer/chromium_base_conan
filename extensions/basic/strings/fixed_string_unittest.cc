...
#include <basic/strings/fixed_string.h>
...
#define FS(x) ::basic::makeFixedString(x)
...
TEST(FixedStringCtorTest, Default) {
  constexpr basic::FixedString<42> s{};
  static_assert(s[0] == '\0', "");
...
TEST(FixedStringCtorTest, FromLiterals) {
  constexpr basic::FixedString<42> s{"hello world"};
  static_assert(s[0] == 'h', "");
  constexpr basic::FixedString<11> s2{"hello world"};
  ...
  // constexpr basic::FixedString<10> s3(a);
}

TEST(FixedStringCtorTest, FromPtrAndLength) {
  constexpr basic::FixedString<11> s{"hello world", 11};
  static_assert(s[0] == 'h', "");
  static_assert(s[10] == 'd', "");
  static_assert(s[11] == '\0', "");
  static_assert(s.size() == 11u, "");

  constexpr basic::FixedString<5> s2{"hello world", 5};
  static_assert(s2[0] == 'h', "");
  static_assert(s2[4] == 'o', "");
  static_assert(s2[5] == '\0', "");
  static_assert(s2.size() == 5u, "");

  constexpr basic::FixedString<20> s3{"hello world", 5};
  static_assert(s2[0] == 'h', "");
  static_assert(s2[4] == 'o', "");
  static_assert(s2[5] == '\0', "");
  static_assert(s2.size() == 5u, "");
...
TEST(FixedStringCtorTest, FromStringAndOffset) {
  constexpr basic::FixedString<11> s{"hello world"};
  constexpr basic::FixedString<5> s2{s, 6u, npos};
  static_assert(s2 == "world", "");
  constexpr basic::FixedString<0> s3{s, 11u, npos};
  static_assert(s3 == "", "");
  // Out of bounds offset, does not compile
  // constexpr basic::FixedString<0> s4{s, 12};
}

TEST(FixedStringCtorTest, FromStringOffsetAndCount) {
  constexpr basic::FixedString<11> s{"hello world"};
  constexpr basic::FixedString<4> s2{s, 6u, 4u};
  static_assert(s2 == "worl", "");
  constexpr basic::FixedString<5> s3{s, 6u, 5u};
  static_assert(s3 == "world", "");
  // Out of bounds count, does not compile:
  // constexpr basic::FixedString<5> s4{s, 6, 6};
}

TEST(FixedStringCtorTest, FromInitializerList) {
  constexpr basic::FixedString<11> s{
      'h', 'e', 'l', 'l', 'o', ' ', 'w', 'o', 'r', 'l', 'd'};
  static_assert(s == "hello world", "");
  // Out of bounds count, does not compile:
  // constexpr basic::FixedString<10> s{
  //     {'h','e','l','l','o',' ','w','o','r','l','d'}};
}

TEST(FixedStringCtorTest, FromUDL) {
  using namespace basic::literals;
#if defined(__GNUC__)
  constexpr auto x = "hello"_fs;
  static_assert(
      std::is_same<decltype(x), const basic::FixedString<5>>::value, "");
  static_assert(x[0] == 'h', "");
  static_assert(x[1] == 'e', "");
  static_assert(x[2] == 'l', "");
  static_assert(x[3] == 'l', "");
  ...
  static_assert(
      std::is_same<decltype(y), const basic::FixedString<8>>::value, "");
  static_assert(y.size() == 7u, "");
  static_assert(y == "goodbye", "");

  constexpr auto z = "now is the time for all good llamas"_fs64;
  static_assert(
      std::is_same<decltype(z), const basic::FixedString<64>>::value, "");
...
constexpr basic::FixedString<20> constexpr_swap_test() {
  basic::FixedString<10> tmp1{"hello"}, tmp2{"world!"};
  tmp2.swap(tmp1);
  return tmp1 + tmp2;
}
...
constexpr basic::FixedString<10> constexpr_assign_string_test_1() {
  basic::FixedString<10> tmp1, tmp2{"world!"};
  tmp1 = tmp2;
  return tmp1;
}
constexpr basic::FixedString<10> constexpr_assign_string_test_2() {
  basic::FixedString<10> tmp{"aaaaaaaaaa"};
  tmp.assign("hello"_fs8);
  return tmp;
}
constexpr basic::FixedString<10> constexpr_assign_string_test_3() {
  basic::FixedString<10> tmp{"aaaaaaaaaa"};
  tmp.assign("goodbye"_fs8, 3u, 2u);
  return tmp;
}
constexpr basic::FixedString<10> constexpr_assign_string_test_4() {
  basic::FixedString<10> tmp{"aaaaaaaaaa"};
...
constexpr basic::FixedString<10> constexpr_assign_literal_test_1() {
  basic::FixedString<10> tmp{"aaaaaaaaaa"};
  tmp = "hello";
...
constexpr basic::FixedString<10> constexpr_assign_literal_test_2() {
  basic::FixedString<10> tmp{"aaaaaaaaaa"};
  tmp.assign("hello");
  return tmp;
}
constexpr basic::FixedString<10> constexpr_assign_literal_test_3() {
  basic::FixedString<10> tmp{"aaaaaaaaaa"};
...
TEST(FixedStringIndexTest, Index) {
  constexpr basic::FixedString<11> digits{"0123456789"};
  ...
  EXPECT_DCHECK_DEATH(digits.at(11));
}

TEST(FixedStringCompareTest, Compare) {
  constexpr basic::FixedString<10> tmp1{"aaaaaaaaaa"};
  constexpr basic::FixedString<12> tmp2{"aaaaaaaaaba"};
  ...
  constexpr basic::FixedString<10> tmp3{"aaa"};
  constexpr basic::FixedString<12> tmp4{"aaaa"};
...
constexpr basic::FixedString<20> constexpr_append_string_test() {
  basic::FixedString<20> a{"hello"}, b{"X world!"};
  a.append(1u, ' ');
  a.append(b, 2u, 5u);
  a.append(b, 7u, 1u);
  return a;
...
constexpr basic::FixedString<20> constexpr_append_literal_test() {
  basic::FixedString<20> a{"hello"};
  a.append(1u, ' ');
...
TEST(FixedStringCAppendTest, CAppendString) {
  constexpr basic::FixedString<10> a{"hello"}, b{"X world!"};
...
TEST(FixedStringCAppendTest, CAppendLiteral) {
  constexpr basic::FixedString<10> a{"hello"};
  constexpr auto tmp1 = a.cappend(' ');
...
constexpr basic::FixedString<10> constexpr_replace_string_test() {
  basic::FixedString<10> tmp{"abcdefghij"};
...
TEST(FixedStringFindTest, FindString) {
  constexpr basic::FixedString<10> tmp{"hijdefghij"};
...
TEST(FixedStringReverseFindTest, FindChar) {
  constexpr basic::FixedString<16> tmp{"This is a string"};
...
constexpr std::size_t countSpacesReverse(basic::FixedString<50> s) {
  std::size_t count = 0u;
  auto i = s.rbegin();
...
TEST(FixedStringConversionTest, ConversionTobasicRange) {
  ...
  static constexpr basic::FixedString<16> tmp{"This is a string"};
  constexpr base::StringPiece piece = tmp;
...
#endif // FIXED_STRING_HAS_STRING_VIEW
