...
#include <basic/memory/not_null.h>
...
#else
    return std::allocator_traits<std::allocator<int>>::construct(p, std::forward<Args>(args)...);
#endif
  }
...
#else
  using value_type = std::allocator_traits<std::allocator<int>>::value_type;
  using pointer = std::allocator_traits<std::allocator<int>>::pointer;
  using const_pointer = std::allocator_traits<std::allocator<int>>::const_pointer;
  using reference = int&;
  using const_reference = const int&;
  using size_type = std::allocator_traits<std::allocator<int>>::size_type;
  using difference_type = std::allocator_traits<std::allocator<int>>::difference_type;
  using propagate_on_container_move_assignment = std::allocator_traits<std::allocator<int>>::propagate_on_container_move_assignment;
  template< class U > struct rebind { typedef std::allocator<U> other; };
  using is_always_equal = std::allocator_traits<std::allocator<int>>::is_always_equal;
#endif
