...
///   functions must be copyable to base::RepeatingCallback without dynamic
...
///   base::RepeatingCallback without dynamic allocation.
...
///       T result;
///       // Note: fn must be copyable to base::RepeatingCallback without dynamic
...
class FlatCombining {
 ...
 public:
  ...
  class Rec {
    alignas(hardware_destructive_interference_size)
        basic::SaturatingSemaphore<false, Atom> valid_;
    basic::SaturatingSemaphore<false, Atom> done_;
    basic::SaturatingSemaphore<false, Atom> disconnected_;
    size_t index_;
    size_t next_;
    uint64_t last_;
    Req req_;
   ...
   public:
    ...
    void setFnCallback(Func&& fn) {
      static_assert(
          ...
          "Try using a smaller function object that can fit in base::RepeatingCallback "
 ...
 protected:
  ...
  alignas(hardware_destructive_interference_size)
      basic::SaturatingSemaphore<true, Atom> pending_;
