...
#include "basic/backoff_entry/backoff_entry_serializer.h" // IWYU pragma: associated
#include "basic/backoff_entry/backoff_entry.h"
...
std::unique_ptr<base::Value> BackoffEntrySerializer::SerializeToValue(
  ...
  serialized->AppendString(
      basic::Int64ToString(absolute_release_time.ToInternalValue()));
