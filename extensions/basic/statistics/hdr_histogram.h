...
// Original java implementation (by giltene): hdrhistogram.github.io/HdrHistogram
//
...
class HdrHistogram {
 ...
 private:
  ...
  static const uint64_t kMinHighestTrackableValue;
  static const int kMinValidNumSignificantDigits;
  static const int kMaxValidNumSignificantDigits;
...
class AbstractHistogramIterator {
 public:
  ...
  basic::Status Next(HistogramIterationValue* value);
