...
#include "basic/status/posix_error_space.h" // IWYU pragma: associated
...
class PosixErrorSpace : public ::basic::ErrorSpace {
 public:
  PosixErrorSpace();
...
PosixErrorSpace::PosixErrorSpace() : ErrorSpace("basic::PosixErrorSpace") {}
...
::basic::error::Code PosixErrorSpace::CanonicalCode(
  ...
  switch (status.error_code()) {
    ...
    case ESPIPE:        // Invalid seek
      code = ::basic::error::INVALID_ARGUMENT;
      break;
    case ETIMEDOUT:  // Connection timed out
    case ETIME:      // Timer expired
      code = ::basic::error::DEADLINE_EXCEEDED;
      break;
    ...
    case ESRCH:      // No such process
      code = ::basic::error::NOT_FOUND;
      break;
    case EEXIST:         // File exists
    case EADDRNOTAVAIL:  // Address not available
    case EALREADY:       // Connection already in progress
    case ENOTUNIQ:       // Name not unique on network
      code = ::basic::error::ALREADY_EXISTS;
      break;
    case EPERM:   // Operation not permitted
    case EACCES:  // Permission denied
    case ENOKEY:  // Required key not available
    case EROFS:   // Read only file system
      code = ::basic::error::PERMISSION_DENIED;
      break;
    ...
    case EUNATCH:     // Protocol driver not attached
      code = ::basic::error::FAILED_PRECONDITION;
      break;
    ...
    case EUSERS:   // Too many users
      code = ::basic::error::RESOURCE_EXHAUSTED;
      break;
    case ECHRNG:     // Channel number out of range
    case EFBIG:      // File too large
    case EOVERFLOW:  // Value too large to be stored in data type
    case ERANGE:     // Result too large
      code = ::basic::error::OUT_OF_RANGE;
      break;
    ...
    case EXDEV:            // Improper link
      code = ::basic::error::UNIMPLEMENTED;
      break;
    ...
    case ENONET:        // Machine is not on the network
      code = ::basic::error::UNAVAILABLE;
      break;
    case EDEADLK:  // Resource deadlock avoided
    case ESTALE:   // Stale file handle
      code = ::basic::error::ABORTED;
      break;
    case ECANCELED:  // Operation cancelled
      code = ::basic::error::CANCELLED;
      break;
