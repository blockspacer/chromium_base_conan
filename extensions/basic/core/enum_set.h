...
//
/// \note See also `basic/core/bitmask.h` and `basic/core/typed_enum.h`
//
...
//
// using TestEnumSet
//   = EnumSet<TestEnum, TestEnum::TEST_MIN, TestEnum::TEST_MAX>;
// const TestEnumSet enums(TestEnum::TEST_3, TestEnum::TEST_1);
// enums.Has(TestEnum::TEST_0);
// enums.Remove(TestEnum::TEST_0);
// enums.Put(TestEnum::TEST_0);
