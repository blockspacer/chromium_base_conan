...
#include <basic/functional/invoke.h>
#include <basic/portability/align.h>
#include <basic/portability/thunk.h>
#include <basic/memory/malloc.h>
#include <basic/portability/config.h>
#include <basic/portability/malloc.h>
 ...
 *
 *      using RSA_deleter = basic::static_function_deleter<RSA, &RSA_free>;
 ...
 *      using BIO_deleter = basic::static_function_deleter<BIO, &BIO_free_fb>;
...
BASIC_CREATE_MEMBER_INVOKER(AllocatorConstruct_, construct);
BASIC_CREATE_MEMBER_INVOKER(AllocatorDestroy_, destroy);

template <typename Void, typename Alloc, typename... Args>
struct AllocatorCustomizesConstruct_
    : basic::is_invocable<AllocatorConstruct_, Alloc, Args...> {};

template <typename Alloc, typename... Args>
struct AllocatorCustomizesConstruct_<
    void_t<typename Alloc::basic_has_default_object_construct>,
    Alloc,
    Args...> : Negation<typename Alloc::basic_has_default_object_construct> {};

template <typename Void, typename Alloc, typename... Args>
struct AllocatorCustomizesDestroy_
    : basic::is_invocable<AllocatorDestroy_, Alloc, Args...> {};

template <typename Alloc, typename... Args>
struct AllocatorCustomizesDestroy_<
    void_t<typename Alloc::basic_has_default_object_destroy>,
    Alloc,
    Args...> : Negation<typename Alloc::basic_has_default_object_destroy> {};
} // namespace detail
 ...
 * basic_has_default_object_construct.  It is helpful to do this if you
 ...
 *
 * Allocator types can override V by declaring a type alias for
 * basic_has_default_object_destroy.  It is helpful to do this if you
