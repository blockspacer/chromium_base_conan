/*
 *  Copyright 2020 The base Project Authors. All rights reserved.
 *
...
#include "basic/containers/bounded_inline_vector_impl.h"
...
class BoundedInlineVector {
 ...
 public:
  ...
  BoundedInlineVector(const BoundedInlineVector<T, other_capacity>& other) {
    DCHECK_LE(other.size(), fixed_capacity);
  ...
  void resize(int new_size) {
    ...
    DCHECK_LE(new_size, fixed_capacity);
