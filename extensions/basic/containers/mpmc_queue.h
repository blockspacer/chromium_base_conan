...
#include <basic/synchronization/turn_sequencer.h>
...
/// that don't use noexcept but that are marked basic::IsRelocatable
/// and std::is_nothrow_constructible, which is common for basic types.
/// In particular, if you can declare BASIC_ASSUME_FBVECTOR_COMPATIBLE
