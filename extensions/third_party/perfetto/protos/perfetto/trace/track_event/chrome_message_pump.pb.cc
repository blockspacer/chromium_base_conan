...
static void InitDefaultsscc_info_ChromeMessagePump_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fmessage_5fpump_2eproto() {
  ...
  ::perfetto::protos::ChromeMessagePump::InitAsDefaultInstance();
}
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChromeMessagePump_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fmessage_5fpump_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ChromeMessagePump_protos_2fperfetto_2ftrace_2ftrack_5fevent_2fchrome_5fmessage_5fpump_2eproto}, {}};
...
void ChromeMessagePump::InitAsDefaultInstance() {
}
...
ChromeMessagePump::ChromeMessagePump()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:perfetto.protos.ChromeMessagePump)
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          sent_messages_in_queue_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          io_handler_location_iid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
bool ChromeMessagePump::MergePartialFromCodedStream(
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:perfetto.protos.ChromeMessagePump)
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (8 & 0xFF)) {
          _Internal::set_has_sent_messages_in_queue(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   bool, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_BOOL>(
                 input, &sent_messages_in_queue_)));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (16 & 0xFF)) {
          _Internal::set_has_io_handler_location_iid(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint64, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT64>(
                 input, &io_handler_location_iid_)));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:perfetto.protos.ChromeMessagePump)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:perfetto.protos.ChromeMessagePump)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void ChromeMessagePump::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:perfetto.protos.ChromeMessagePump)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(1, this->sent_messages_in_queue(), output);
  }

  // optional uint64 io_handler_location_iid = 2;
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(2, this->io_handler_location_iid(), output);
  }

  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:perfetto.protos.ChromeMessagePump)
}
...
void ChromeMessagePump::InternalSwap(ChromeMessagePump* other) {
  ...
  swap(io_handler_location_iid_, other->io_handler_location_iid_);
  swap(sent_messages_in_queue_, other->sent_messages_in_queue_);
}
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::ChromeMessagePump* Arena::CreateMaybeMessage< ::perfetto::protos::ChromeMessagePump >(Arena* arena) {
  return Arena::CreateInternal< ::perfetto::protos::ChromeMessagePump >(arena);
}
