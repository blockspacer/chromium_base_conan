...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TaskExecution_protos_2fperfetto_2ftrace_2ftrack_5fevent_2ftask_5fexecution_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_TaskExecution_protos_2fperfetto_2ftrace_2ftrack_5fevent_2ftask_5fexecution_2eproto}, {}};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          posted_from_iid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (8 & 0xFF)) {
          _Internal::set_has_posted_from_iid(&_has_bits_);
...
void TaskExecution::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(1, this->posted_from_iid(), output);
  }
