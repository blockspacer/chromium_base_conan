...
if(("x${CMAKE_CXX_COMPILER_ID}" MATCHES "x.*Clang" AND "x${CMAKE_CXX_SIMULATE_ID}" STREQUAL "xMSVC") OR "x${CMAKE_CXX_COMPILER_ID}" STREQUAL "xMSVC")
    ...
    if(WIN32)
      set(_CXX_COROUTINES_AWAIT "/clang:-fcoroutines-ts")
    else()
...
#set(CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS} ${_CXX_COROUTINES_AWAIT} ${_CXX_COROUTINES_STDLIB}")
...
if(find_final)
    ...
    message(STATUS "<coroutine> header not found")
endif()
...
if(find_experimental)
    ...
    message(STATUS "<experimental/coroutine> header not found")
endif()
