...
/// \todo FIXME constant expression evaluates to -61 which cannot be narrowed to type 'unsigned char'
...
// different sizes.
TEST(EscapeTest, InvalidApplicationBody) {
...
// accepted inputs.
TEST(EscapeTest, ValidApplicationBody) {
  std::vector<std::string> names = {"name1", "name2"};
